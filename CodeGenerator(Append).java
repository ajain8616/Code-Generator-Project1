...
class CodeGenerator
{
    ...
    public CodeGenerator(String func, int rtype, String params[])
    {
        this.func_name = func;
        this.ret_type = get_ptype(rtype);
        this.params = params;
...
public class Main {
    ...
    {
        String []parameters = {"double","a"};
        CodeGenerator cgen = new CodeGenerator("arihant",1,parameters);
